    ...
    public class PlayerViewViewStateTackling : PlayerViewState{
        ...
        public PlayerViewViewStateTackling(Sprite sprite) {
        ...
        public override void OnEnter() {
            ...
            if (stateData.MoveDir.sqrMagnitude <= 0.01f) moveDir = PlayerView.headingRight ? Vector2.right : Vector2.left;
